...
@NUMERIC = qw( id );
@NON_NUMERIC = qw( name positioning alignment font color size style sep modified owner usergroup permissions );
...
This is the Navigation Bar base class for SPINE.
