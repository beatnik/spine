package SPINE::Base::Messagegroup;
...
@NUMERIC = qw( id );
@NON_NUMERIC = qw( name owner usergroup permissions content );
...
SPINE::Base::Messagegroup

=head1 DESCRIPTION

This is the Messagegroup base class for SPINE.
