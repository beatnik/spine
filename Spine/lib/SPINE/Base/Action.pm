...
@NUMERIC = qw( id );
@NON_NUMERIC = qw( datatype dataname action actiontime owner actionkey actionvalue description );
...
This is the Action base class for SPINE.

This module offers developers the possibility to expand SPINE core tables without breaking existing database structure.
