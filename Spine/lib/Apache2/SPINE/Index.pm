...
use Apache2::Request; #This one is SWEEEEEEEEEEET!!
...
{ my $r = shift;
  ...
  { my $user = shift @{$user_dbi->get({login=>$req->param('name'),password=>md5_hex($req->param('password'))})};
    ...
    { my @chars = ("a".."z","A".."Z",0..9);
      ...
      $req->err_headers_out->add('Set-Cookie' => $cookie->as_string);  
